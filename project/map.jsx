...
function MapView({
  ...
  useEffect(() => {
    ...
    // Build per-segment polylines for color-by; if none, single polyline
    if (colorBy && colorBy !== 'none'){
      // simplification: draw polyline per pair (renderer is canvas, fine for ~600 pts)
